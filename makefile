...
UTILSOBJECTS=fceu/utils/ConvertUTF.o fceu/utils/general.o fceu/utils/memory.o fceu/utils/crc32.o fceu/utils/guid.o fceu/utils/endian.o fceu/utils/md5.o fceu/utils/xstring.o
...
OBJECTS=$(CCLIBOBJECTS) $(EMUOBJECTS) headless-driver.o emulator.o
